...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
            figure=px.bar(exp_rec,
            x='Vehicle_type',
            y='Advertising Expenditure',
            title="Advertising_Expenditure by vehicle type"))

# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        #grouping data for plotting
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        unemp_data = recession_data.groupby('Vehicle_Type')['unemployment_rate', 'Automobile_Sales']
        R_chart4 = dcc.Graph(figure=px.bar(unemp_data,
        x='Vehicle_Type',
        y='unemployment_rate and Automobile_Sales',
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots
    ...
    elif (input_year and selected_statistics==True) :
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas,x='Year',y='Automobile_Sales',
            title='Average Vehicles Sold by year {}'.format(input_year)
            ))
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
         # grouping data for plotting.
         # Hint:Use the columns Year and Automobile_Sales
        avr_vdata=yearly_data.groupby('Vehicle_Type')['Advertising_Expenditure'].mean().reset_index()
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(igure=px.line(exp_data,x='Vehicle_Type',y='Advertising_Expenditure',
